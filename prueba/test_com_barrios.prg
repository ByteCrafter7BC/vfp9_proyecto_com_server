...
separador()
? "Prueba: 3 | Método: 'nombre_existe' | Valor: 'centro', 9, 115"
? 'Resultado esperado: pasar'
? 'Existe: ' + IIF(poRepositorio.nombre_existe('centro', 9, 115), 'Sí', 'No')

IF !poRepositorio.nombre_existe('centro', 9, 115) THEN
    RETURN .F.
ENDIF

separador()
? "Prueba: 4 | Método: 'nombre_existe' | Valor: 'monark', 10, 12"
? 'Resultado esperado: fallar'
? 'Existe: ' + IIF(poRepositorio.nombre_existe('monark', 10, 12), 'Sí', 'No')

IF poRepositorio.nombre_existe('monark', 10, 12) THEN
    RETURN .F.
ENDIF
