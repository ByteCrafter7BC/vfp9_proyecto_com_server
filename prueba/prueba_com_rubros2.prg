...
**/
* @file prueba_com_rubros2.prg
* @package prueba
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @description Programa principal para ejecutar las pruebas de 'com_rubros2'.
*/
...
? "Iniciando pruebas de 'com_rubros2'..."
? REPLICATE('=', 40)
...
**/
* Clase de pruebas para 'com_rubros2'.
*/
DEFINE CLASS prueba_com_rubros2 AS conjunto_prueba OF conjunto_prueba.prg
    **/
    * @var object Objeto de la capa de negocio 'com_rubros2'.
    */
    PROTECTED oCom
    ...
    */
    PROCEDURE prueba_existe
        ...
        THIS.ejecutar_prueba([Método: existe_nombre | tcNombre: 'Cigueñal'], ;
            THIS.afirmar_verdadero(THIS.oCom.existe_nombre('Cigueñal'), ;
                "Debe existir el nombre 'Cigueñal'."))
