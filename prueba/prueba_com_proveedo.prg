...
**/
* @file prueba_com_proveedo.prg
* @package prueba
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @description Programa principal para ejecutar las pruebas de 'com_proveedo'.
*/

**/
* Programa principal que crea un conjunto de pruebas y ejecuta todas las pruebas
* definidas en la clase 'prueba_com_proveedo'.
*
...
loConjuntoPrueba = CREATEOBJECT('prueba_com_proveedo')
...
? "Iniciando pruebas de 'com_proveedo'..."
? REPLICATE('=', 40)
...
**/
* Clase de pruebas para 'com_proveedo'.
*/
DEFINE CLASS prueba_com_proveedo AS conjunto_prueba OF conjunto_prueba.prg
    **/
    * @var object Objeto de la capa de negocio 'com_proveedo'.
    */
    PROTECTED oCom
    ...
    * @uses object oCom Objeto de la capa de negocio 'com_proveedo'.
    */
    PROCEDURE prueba_existe
        ...
        THIS.ejecutar_prueba( ;
                [Método: existe_nombre | tcNombre: 'Lincoln S.A.'], ;
            THIS.afirmar_verdadero(THIS.oCom.existe_nombre('Lincoln S.A.'), ;
                "Debe existir el nombre 'Lincoln S.A.'."))
    ...
    */
    PROCEDURE prueba_vigente
        THIS.ejecutar_prueba('Método: esta_vigente | tnCodigo: 4', ;
            THIS.afirmar_verdadero(THIS.oCom.esta_vigente(4), ;
                'El código 4 debe estar vigente.'))
    ...
    */
    PROCEDURE prueba_contar
        ...
        lcCondicionFiltro = ;
            'nombre == [ASEGURADORA DEL ESTE S.A.               ]'
    ...
    PROCEDURE prueba_agregar
        ...
        IF es_objeto(THIS.oDto) THEN
            WITH THIS.oDto
                ...
                .establecer('ruc', '518613-7')
                .establecer('vigente', 'S')
            ENDWITH
        ENDIF
    ...
    PROCEDURE prueba_modificar
        ...
        IF es_objeto(THIS.oDto) THEN
            WITH THIS.oDto
                ...
                .establecer('ruc', '666357')
                .establecer('vigente', 'N')
            ENDWITH
        ENDIF
    ...
    */
    PROTECTED FUNCTION Init
        ...
        THIS.oCom = NEWOBJECT('com_proveedo', 'com_proveedo.prg')
    ...
    * @uses oCom object Objeto de la capa de negocio 'com_proveedo'.
    */
