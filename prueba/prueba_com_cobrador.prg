...
**/
* @file prueba_com_cobrador.prg
* @package prueba
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @description Programa principal para ejecutar las pruebas de 'com_cobrador'.
*/

**/
* Programa principal que crea un conjunto de pruebas y ejecuta todas las pruebas
* definidas en la clase 'prueba_com_cobrador'.
*/
CLEAR

LOCAL loConjuntoPrueba
loConjuntoPrueba = CREATEOBJECT('prueba_com_cobrador')
...
? "Iniciando pruebas de 'com_cobrador'..."
? REPLICATE('=', 40)
...
**/
* Clase de pruebas para 'com_cobrador'.
*/
DEFINE CLASS prueba_com_cobrador AS conjunto_prueba OF conjunto_prueba.prg
    **/
    * @var object Objeto de la capa de negocio 'com_cobrador'.
    */
    PROTECTED oCom
    ...
    */
    PROCEDURE prueba_existe
        ...
        THIS.ejecutar_prueba( ;
            [Método: existe_nombre | tcNombre: 'Alvarez, Felipe'], ;
    ...
    */
    PROTECTED FUNCTION Init
        ...
        THIS.oCom = NEWOBJECT('com_cobrador', 'com_cobrador.prg')
