...
separador()
? "Prueba: 3 | Método: 'nombre_existe' | Valor: 'alvarez, felipe'"
? 'Resultado esperado: pasar'
? 'Existe: ' + IIF(poRepositorio.nombre_existe('alvarez, felipe'), 'Sí', 'No')

IF !poRepositorio.nombre_existe('alvarez, felipe') THEN
    RETURN .F.
ENDIF
