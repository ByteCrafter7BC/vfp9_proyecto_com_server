...
**/
* @file prueba_com_mecanico.prg
* @package prueba
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @description Programa principal para ejecutar las pruebas de 'com_mecanico'.
*/

**/
* Programa principal que crea un conjunto de pruebas y ejecuta todas las pruebas
* definidas en la clase 'prueba_com_mecanico'.
*/
CLEAR

LOCAL loConjuntoPrueba
loConjuntoPrueba = CREATEOBJECT('prueba_com_mecanico')
...
? "Iniciando pruebas de 'com_mecanico'..."
? REPLICATE('=', 40)
...
**/
* Clase de pruebas para 'com_mecanico'.
*/
DEFINE CLASS prueba_com_mecanico AS conjunto_prueba OF conjunto_prueba.prg
    **/
    * @var object Objeto de la capa de negocio 'com_mecanico'.
    */
    PROTECTED oCom
    ...
    */
    PROCEDURE prueba_existe
        THIS.ejecutar_prueba('Método: existe_codigo | tnCodigo: 66', ;
            THIS.afirmar_verdadero(THIS.oCom.existe_codigo(66), ;
                'Debe existir el código 66.'))
        ...
        THIS.ejecutar_prueba( ;
            [Método: existe_nombre | tcNombre: 'Godoy Candia, Florio Alcides'], ;
            THIS.afirmar_verdadero(THIS.oCom.existe_nombre( ;
                'Godoy Candia, Florio Alcides'), ;
                "Debe existir el nombre 'Alvarez, Felipe'."))
    ...
    */
    PROCEDURE prueba_vigente
        THIS.ejecutar_prueba('Método: esta_vigente | tnCodigo: 71', ;
            THIS.afirmar_verdadero(THIS.oCom.esta_vigente(71), ;
                'El código 71 debe estar vigente.'))
    ...
    */
    PROCEDURE prueba_contar
        ...
        lcCondicionFiltro = 'nombre == [GAUTO, ARIEL                  ]'
    ...
    */
    PROTECTED FUNCTION Init
        ...
        THIS.oCom = NEWOBJECT('com_mecanico', 'com_mecanico.prg')
