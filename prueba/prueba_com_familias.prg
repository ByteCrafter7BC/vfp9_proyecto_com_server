...
**/
* @file prueba_com_familias.prg
* @package prueba
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @description Programa principal para ejecutar las pruebas de 'com_familias'.
*/

**/
* Programa principal que crea un conjunto de pruebas y ejecuta todas las pruebas
* definidas en la clase 'prueba_com_familias'.
*/
CLEAR

LOCAL loConjuntoPrueba
loConjuntoPrueba = CREATEOBJECT('prueba_com_familias')
...
? "Iniciando pruebas de 'com_familias'..."
? REPLICATE('=', 40)
...
**/
* Clase de pruebas para 'com_familias'.
*/
DEFINE CLASS prueba_com_familias AS conjunto_prueba OF conjunto_prueba.prg
    **/
    * @var object Objeto de la capa de negocio 'com_familias'.
    */
    PROTECTED oCom
    ...
    */
    PROCEDURE prueba_existe
        THIS.ejecutar_prueba('Método: existe_codigo | tnCodigo: 2', ;
            THIS.afirmar_verdadero(THIS.oCom.existe_codigo(2), ;
                'Debe existir el código 2.'))
        ...
        THIS.ejecutar_prueba( ;
            [Método: existe_nombre | tcNombre: 'Trapp Repuestos'], ;
            THIS.afirmar_verdadero(THIS.oCom.existe_nombre('Trapp Repuestos'), ;
                "Debe existir el nombre 'Trapp Repuestos'."))
    ...
    */
    PROCEDURE prueba_contar
        ...
        lcCondicionFiltro = 'nombre == [EMAC MAQUINAS                 ]'
    ...
    */
    PROTECTED FUNCTION Init
        ...
        THIS.oCom = NEWOBJECT('com_familias', 'com_familias.prg')
