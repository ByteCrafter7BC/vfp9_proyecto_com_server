...
poRepositorio = NEWOBJECT('com_vendedor', 'com_vendedor.prg')
...
separador()
? "Prueba: 14 | Método: 'obtener_por_nombre' | Valor: 'tienda web'"
? 'Resultado esperado: pasar'
poModelo = poRepositorio.obtener_por_nombre('tienda web')
IF !imprimir() THEN
    RETURN .F.
ENDIF
