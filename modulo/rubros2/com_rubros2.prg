...
**/
* Componente COM para la gestión de subrubros de artículos.
*
* Esta clase actúa como un controlador o una capa de servicio (business object)
* para la entidad 'rubros2'. Se expone como un objeto COM para ser utilizado
* por otras aplicaciones.
*/
DEFINE CLASS com_rubros2 AS com_base OF com_base.prg OLEPUBLIC
    **/
