...
**/
* Objeto de Transferencia de Datos (DTO) para la tabla de subrubros.
*
...
* vigencia.
*
* Su propósito es servir como un DTO especializado para la entidad 'rubros2',
