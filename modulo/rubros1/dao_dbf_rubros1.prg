...
**/
* @file dao_dbf_rubros1.prg
* @package modulo\rubros1
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @class dao_dbf_rubros1
* @extends biblioteca\dao_dbf
* @uses constantes.h
*/

**/
* Clase de objeto de acceso a datos (DAO) para la tabla de rubros en formato
* DBF.
*
* Esta clase hereda la funcionalidad básica de la clase 'dao_dbf' y la
* especializa para la tabla 'rubros1'. Su propósito es manejar las operaciones
...
DEFINE CLASS dao_dbf_rubros1 AS dao_dbf OF dao_dbf.prg
    **/
    ...
    * ('maesprod').
    *
    * @param int tnCodigo Código del rubro a verificar.
    *
