...
**/
* @file validador_rubros1.prg
* @package modulo\rubros1
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @class validador_rubros1
* @extends biblioteca\validador_base
*/

**
* Clase validadora para la entidad de rubros.
*
...
* de tipo 'rubros1'.
*
* Su propósito es asegurar que los datos de los rubros cumplan con las reglas
...
*/
DEFINE CLASS validador_rubros1 AS validador_base OF validador_base.prg
    **/
