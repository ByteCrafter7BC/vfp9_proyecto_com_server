...
**/
* @file validador_marcas2.prg
* @package biblioteca
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @class validador_marcas2
* @extends validador_base
*/

**
* Clase validadora para la entidad de marcas.
*
...
* de tipo 'marcas2'.
*
* Su propósito es asegurar que los datos de las marcas cumplan con las reglas
...
*/
DEFINE CLASS validador_marcas2 AS validador_base OF validador_base.prg
    **/
