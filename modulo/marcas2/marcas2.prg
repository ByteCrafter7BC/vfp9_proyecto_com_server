...
**
* Clase modelo de datos para la entidad de marcas.
*
...
* marcas en la capa de modelos. Al heredar de 'modelo_base', asegura
...
*/
DEFINE CLASS marcas2 AS modelo_base OF modelo_base.prg
    **/
