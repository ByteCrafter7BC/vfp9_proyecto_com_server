...
DEFINE CLASS validador_barrios AS validador_base OF validador_base.prg
    ...
    *
    * @return bool .T. si a propiedad 'ciudad' del modelo es válido;
    *              .F. en caso contrario.
    * @uses string campo_obtener_ultimo_error(string tcCampo)
    *       Para obtener el último mensaje de error del campo.
    * @uses bool campo_establecer_ultimo_error(string tcCampo, ;
    ...
    */
    PROTECTED FUNCTION validar_ciudad
        ...
        * Verifica que el campo 'departamen' no contenga errores.
        ...
        WITH loCampo
            lcEtiqueta = .obtener_etiqueta()
            loModelo = dao_obtener_por_codigo('ciudades', .obtener_valor())
        ENDWITH
