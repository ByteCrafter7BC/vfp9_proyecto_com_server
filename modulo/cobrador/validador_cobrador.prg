...
**/
* @file validador_cobrador.prg
* @package modulo\cobrador
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @class validador_cobrador
* @extends biblioteca\validador_base
*/

**
* Clase validadora para la entidad de cobradores.
*
...
* de tipo 'cobrador'.
*
* Su propósito es asegurar que los datos de los cobradores cumplan con las reglas
...
*/
DEFINE CLASS validador_cobrador AS validador_base OF validador_base.prg
    **/
