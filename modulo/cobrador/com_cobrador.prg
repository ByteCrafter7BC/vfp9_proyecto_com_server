...
**/
* Clase de lógica de negocio para la gestión de cobradores.
*
...
* operaciones del modelo 'cobrador' sin necesidad de reescribir la lógica
...
*/
DEFINE CLASS com_cobrador AS com_base OF com_base.prg OLEPUBLIC
    **/
