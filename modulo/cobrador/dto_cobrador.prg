...
**/
* Objeto de Transferencia de Datos (DTO) para la tabla de cobradores.
*
...
* vigencia.
*
* Su propósito es servir como un DTO especializado para la entidad 'cobrador',
...
* aplicación.
*/
DEFINE CLASS dto_cobrador AS dto_base OF dto_base.prg
    **/
