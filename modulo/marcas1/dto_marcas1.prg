...
**/
* Objeto de Transferencia de Datos (DTO) para la tabla de marcas.
*
...
* vigencia.
*
* Su propósito es servir como un DTO especializado para la entidad 'marcas1',
