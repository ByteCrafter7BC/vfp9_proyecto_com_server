...
**/
* @file validador_mecanico.prg
* @package modulo\mecanico
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @class validador_mecanico
* @extends biblioteca\validador_base
*/

**
* Clase validadora para la entidad de mecánicos.
*
...
* de tipo 'mecanico'.
*
* Su propósito es asegurar que los datos de los mecánicos cumplan con las reglas
