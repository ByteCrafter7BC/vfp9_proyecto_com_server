...
**/
* Objeto de Transferencia de Datos (DTO) para la tabla de mecánicos.
*
...
* vigencia.
*
* Su propósito es servir como un DTO especializado para la entidad 'mecanico',
...
* aplicación.
*/
DEFINE CLASS dto_mecanico AS dto_base OF dto_base.prg
    **/
