...
**/
* Clase de lógica de negocio para la gestión de mecánicos.
*
...
* operaciones del modelo 'mecanico' sin necesidad de reescribir la lógica
...
*/
DEFINE CLASS com_mecanico AS com_base OF com_base.prg OLEPUBLIC
    **/
