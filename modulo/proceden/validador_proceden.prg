...
**/
* @file validador_proceden.prg
* @package modulo\proceden
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @class validador_proceden
* @extends biblioteca\validador_base
*/

**
* Clase validadora para la entidad de países.
*
...
* de tipo 'proceden'.
*
* Su propósito es asegurar que los datos de los países cumplan con las reglas
...
*/
DEFINE CLASS validador_proceden AS validador_base OF validador_base.prg
    **/
