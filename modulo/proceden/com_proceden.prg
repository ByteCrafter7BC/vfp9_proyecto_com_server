...
**/
* Clase de lógica de negocio para la gestión de países.
*
...
* operaciones del modelo 'proceden' sin necesidad de reescribir la lógica
...
*/
DEFINE CLASS com_proceden AS com_base OF com_base.prg OLEPUBLIC
    **/
