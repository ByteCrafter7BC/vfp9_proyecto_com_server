...
**/
* Componente COM para la gestión de vendedores.
*
* Esta clase actúa como un controlador o una capa de servicio (business object)
* para la entidad 'vendedor'. Se expone como un objeto COM para ser utilizado
* por otras aplicaciones.
*/
DEFINE CLASS com_vendedor AS com_base OF com_base.prg OLEPUBLIC
    **/
