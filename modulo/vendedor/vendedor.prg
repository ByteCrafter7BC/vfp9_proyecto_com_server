...
**
* Clase modelo de datos para la entidad de vendedores.
*
...
* vendedores en la capa de modelos. Al heredar de 'modelo_base', asegura
...
*/
DEFINE CLASS vendedor AS modelo_base OF modelo_base.prg
    **/
