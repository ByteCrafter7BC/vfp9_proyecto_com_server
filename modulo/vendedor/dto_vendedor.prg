...
**/
* Objeto de Transferencia de Datos (DTO) para la tabla de vendedores.
*
...
* vigencia.
*
* Su propósito es servir como un DTO especializado para la entidad 'vendedor',
...
* aplicación.
*/
DEFINE CLASS dto_vendedor AS dto_base OF dto_base.prg
    **/
