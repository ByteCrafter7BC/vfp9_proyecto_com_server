...
**/
* Clase de lógica de negocio para la gestión de departamentos.
*
...
* operaciones del modelo 'depar' sin necesidad de reescribir la lógica
...
*/
DEFINE CLASS com_depar AS com_base OF com_base.prg OLEPUBLIC
    **/
