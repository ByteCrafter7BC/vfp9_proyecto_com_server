...
**
* Clase modelo de datos para la entidad de departamentos.
*
...
* departamentos en la capa de modelos. Al heredar de 'modelo_base', asegura
...
*/
DEFINE CLASS depar AS modelo_base OF modelo_base.prg
    **/
