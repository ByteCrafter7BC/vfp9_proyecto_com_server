...
**/
* Componente COM para la gestión de máquinas para órdenes de trabajo.
*
* Esta clase actúa como un controlador o una capa de servicio (business object)
* para la entidad 'maquinas'. Se expone como un objeto COM para ser utilizado
