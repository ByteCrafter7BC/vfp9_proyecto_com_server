...
**/
* @file prueba_com_maquinas.prg
* @package prueba
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @description Programa principal para ejecutar las pruebas de 'com_maquinas'.
*/

**/
* Programa principal que crea un conjunto de pruebas y ejecuta todas las pruebas
* definidas en la clase 'prueba_com_maquinas'.
*/
CLEAR

LOCAL loConjuntoPrueba
loConjuntoPrueba = CREATEOBJECT('prueba_com_maquinas')
...
? "Iniciando pruebas de 'com_maquinas'..."
? REPLICATE('=', 40)
...
**/
* Clase de pruebas para 'com_maquinas'.
*/
DEFINE CLASS prueba_com_maquinas AS conjunto_prueba OF conjunto_prueba.prg
    **/
    * @var object Objeto de la capa de negocio 'com_maquinas'.
    */
    PROTECTED oCom
    ...
    */
    PROCEDURE prueba_existe
        ...
        THIS.ejecutar_prueba([Método: existe_nombre | tcNombre: 'Motosierra'], ;
            THIS.afirmar_verdadero(THIS.oCom.existe_nombre('Motosierra'), ;
                "Debe existir el nombre 'Motosierra'."))
    ...
    */
    PROCEDURE prueba_contar
        ...
        lcCondicionFiltro = 'nombre == [BORDEADORA                    ]'
    ...
    */
    PROTECTED FUNCTION Init
        ...
        THIS.oCom = NEWOBJECT('com_maquinas', 'com_maquinas.prg')
