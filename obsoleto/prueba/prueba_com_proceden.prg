...
**/
* @file prueba_com_proceden.prg
* @package prueba
* @author ByteCrafter7BC <bytecrafter7bc@gmail.com>
* @version 1.0.0
* @since 1.0.0
* @description Programa principal para ejecutar las pruebas de 'com_proceden'.
*/

**/
* Programa principal que crea un conjunto de pruebas y ejecuta todas las pruebas
* definidas en la clase 'prueba_com_proceden'.
*/
CLEAR

LOCAL loConjuntoPrueba
loConjuntoPrueba = CREATEOBJECT('prueba_com_proceden')
...
? "Iniciando pruebas de 'com_proceden'..."
? REPLICATE('=', 40)
...
**/
* Clase de pruebas para 'com_proceden'.
*/
DEFINE CLASS prueba_com_proceden AS conjunto_prueba OF conjunto_prueba.prg
    **/
    * @var object Objeto de la capa de negocio 'com_proceden'.
    */
    PROTECTED oCom
    ...
    */
    PROCEDURE prueba_existe
        ...
        THIS.ejecutar_prueba( ;
            [Método: existe_nombre | tcNombre: 'Paraguay'], ;
            THIS.afirmar_verdadero(THIS.oCom.existe_nombre('Paraguay'), ;
                "Debe existir el nombre 'Paraguay'."))
    ...
    */
    PROCEDURE prueba_contar
        ...
        lcCondicionFiltro = 'nombre == [ALEMANIA                      ]'
    ...
    */
    PROTECTED FUNCTION Init
        ...
        THIS.oCom = NEWOBJECT('com_proceden', 'com_proceden.prg')
