...
**
* Clase de transferencia de datos (DTO) para la entidad 'proceden'.
*
* Esta clase se utiliza para transportar datos de países entre diferentes capas
* de la aplicación. Hereda de 'dto_base'.
*/
DEFINE CLASS dto_proceden AS dto_base OF dto_base.prg
    **/
