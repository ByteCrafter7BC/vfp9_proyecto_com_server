...
DEFINE CLASS repositorio_proceden AS repositorio_base OF repositorio_base.prg
    **--------------------------------------------------------------------------
    FUNCTION esta_relacionado
        ...
        llRelacionado = .F.
        lcCondicionFiltro = 'procedenci == ' + ALLTRIM(STR(tnCodigo))
