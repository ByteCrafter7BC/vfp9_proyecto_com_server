...
DEFINE CLASS modelo_base AS Custom
    ...
    */
    FUNCTION es_igual
        ...
        IF toModelo.obtener('codigo') != lnCodigo THEN
    ...
    */
    PROTECTED FUNCTION existe_campo
        ...
        * fin { validaciones }
        ...
        RETURN IIF(THIS.posicion_campo(tcCampo) > 0) THEN
    ENDFUNC
    ...
    */
    PROTECTED FUNCTION obtener_campo
        ...
        * fin { validaciones de parámetros }
        ...
        LOCAL lnPos, lnDecimales, loCampo
        lnPos = THIS.posicion_campo(tcCampo)
        lnDecimales = 0
        ...
        IF VARTYPE(THIS.aCampo[lnPos, 04] != 'L' THEN
            lnDecimales = THIS.aCampo[lnPos, 04]
        ENDIF
        ...
        ADDPROPERTY(loCampo, 'decimales', lnDecimales)
