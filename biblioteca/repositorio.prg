...
DEFINE CLASS repositorio AS Custom
    ...
    **--------------------------------------------------------------------------
    FUNCTION Init
        DIMENSION THIS.aRepositorio[13, 2]
        ...
        WITH THIS
            ...
            .aRepositorio[09, 1] = 'modelos'
            .aRepositorio[10, 1] = 'proceden'
            .aRepositorio[11, 1] = 'rubros1'
            .aRepositorio[12, 1] = 'rubros2'
            .aRepositorio[13, 1] = 'vendedor'
        ENDWITH
    ENDFUNC
